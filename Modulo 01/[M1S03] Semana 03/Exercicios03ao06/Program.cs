...
ContaBancaria conta1 = new ContaBancaria(1542, 1234, "Soraia Cunha", TipoContaEnum.POUPANCA);
ContaBancaria conta2 = new ContaBancaria(1545, 1234, "Soraia Cunha", TipoContaEnum.POUPANCA);
